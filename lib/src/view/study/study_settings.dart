...
class StudySettings extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final ctrlProvider = studyControllerProvider(id);

    final isLocalEvaluationAllowed = ref.watch(
      ctrlProvider.select((s) => s.requireValue.isLocalEvaluationAllowed),
    );
    final isEngineAvailable = ref.watch(
      ctrlProvider.select((s) => s.requireValue.isEngineAvailable),
    );
    ...
    // TODO most of these settings are not implemented yet!
    ...
    return BottomSheetScrollableContainer(
      children: [
        ...
        // TODO move out of analysis preferences!
        SwitchSettingTile(
